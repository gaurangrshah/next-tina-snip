...
export const DrawerMenu = ({ isOpen, onOpen, onClose, children, Logo, title, ...rest }) => {
  ...
  return (
    <>
      ...
      <Drawer isOpen={isOpen} placement="top" onClose={onClose} isFullHeight finalFocusRef={ref}>
